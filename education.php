  ...
  <img src="https://t3.ftcdn.net/jpg/01/21/65/70/360_F_121657098_YvxONbFlEukCVGNun6vokx4Q6EcqVw0u.jpg" alt="" srcset=""></div>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="index.php #Technology">Technology</a>
        </li>
            ...
            <a  class="nav-link" href="education.php">Education</a></li>
          </ul>
        </li>
...
<section class="my-5" id="Education">
    <div class="py-5">
       ...
       <div class="container-fluid">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-12">
                <img src="img/education.jpg" class="img-fluid aboutimg" >
                </div>
                <div class="col-lg-6 col-md-6 col-12">
  ...
  <div class="offcanvas-body">
    ...
    <div class="dropdown mt-3">
      ...
      <ul class="dropdown-menu">
        <li><a class="dropdown-item" href="https://en.wikipedia.org/wiki/Ballygunge_Government_High_School" target="_blank" >Ballygunge Government High School</a></li>
        <li><a class="dropdown-item" href="https://www.dreaminstituteonline.com/" target="_blank">Dream Institute of Technology</a></li>
        <li><a class="dropdown-item" href="https://www.kodnest.com/" target="_blank">Kodnest</a></li>
      </ul>
    </div>
  </div>
</div>
